...
export class PerformanceEditor implements OnInit, AfterViewChecked {
  ...
  openDialog(): void {
    const options = {
      ...
      sections: [`Deleting a performance`,'Viewing/Editing a Performance', 'Performance Details', 'Pieces and Intermissions', 'Fill Casts', 'Finalize'],
      messages: [
        `Make sure to have the performance you want to delete selected. Once selected, hit the "cancel" button to delete it.`,
